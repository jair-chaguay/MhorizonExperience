      ...
      <div className="max-w-310 mx-auto px-[5%]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-12.5 lg:gap-20 items-center">
          ...
          <div className="relative z-20" data-aos="fade-left">
            ...
            <h2 className="text-white font-['Plus_Jakarta_Sans'] font-extrabold text-[2.2rem] leading-[1.4] tracking-[-0.02em] mb-7.5">
              {DIRECTOR_DATA.quote}
            </h2>
            ...
            <div className="border-l-4 border-[#32A09C] pl-5 mt-7.5">
              <h4 className="text-white font-['Plus_Jakarta_Sans'] font-extrabold text-[1.3rem] m-0 leading-[1.2]">
                {DIRECTOR_DATA.name}
              </h4>
              <span className="text-[#32A09C] font-['Plus_Jakarta_Sans'] font-bold text-[0.9rem] uppercase tracking-[1px]">
