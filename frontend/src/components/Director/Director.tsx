...
export const Director = () => {
  ...
  return (
    <section className="py-24 px-6 md:px-12 max-w-360 mx-auto overflow-hidden">
      <motion.div 
      ...
      >
        ...
        >
          <div className="w-56 h-56 md:w-72 md:h-81 rounded-lg overflow-hidden border-8 border-slate-800 shadow-xl relative group">
            <img 
              src={author.image} 
        ...
        >
          <h2 className="font-display mx-auto text-lg md:text-3xl md:font-medium text-white mb-8 leading-snug">
            "{quote}"
          </h2>
          
          <div className="flex items-center md:mx-0 mx-auto gap-4 bg-slate-800 w-fit pr-6 rounded-md border border-slate-700 shadow-md transform hover:translate-x-2 transition-transform duration-300">
